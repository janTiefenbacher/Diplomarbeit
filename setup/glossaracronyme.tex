...
\newglossaryentry{KPIs}
{
    name=KPIs,
    description={Key Performance Indicators (Leistungskennzahlen). Metriken, die den Erfolg oder Fortschritt eines Projekts oder einer Anwendung messen, z.\,B. Nutzerbindung, Ladezeiten oder Fehlerquoten}
}
\newglossaryentry{eCPM}
{
    name=eCPM,
    description={Effective Cost Per Mille (effektiver Tausender-Kontakt-Preis). Eine Kennzahl im Online-Marketing, die angibt, wie viel ein Werbetreibender pro 1.000 Impressionen zahlt, berechnet als (Einnahmen / Impressionen) * 1000}
}
