...
{
    name=API,
    description={Application Programming Interface. Eine Schnittstelle, über die verschiedene Softwarekomponenten oder externe Dienste miteinander kommunizieren und Funktionen austauschen können.}
}
\newglossaryentry{css}
{
    name=CSS,
