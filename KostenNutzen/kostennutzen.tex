...
Die während der Entwicklung angefallenen beziehungsweise anfallenden Entwicklungskosten werden in dieser Analyse bewusst nicht berücksichtigt, da der Fokus ausschließlich auf der theoretischen Wirtschaftlichkeit im laufenden Betrieb der Anwendung liegt. Ebenso werden mögliche Betreuungs-, Wartungs- und Weiterentwicklungskosten während des laufenden Betriebs der App in dieser Betrachtung nicht einbezogen, da diese je nach Umfang der zukünftigen Betreuung stark variieren können und für die vorliegende Modellrechnung nur eine untergeordnete Rolle spielen.\section{Skalierungsstrategie}
