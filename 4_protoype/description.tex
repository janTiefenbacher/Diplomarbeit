...
Als Grundlage der Planung dienten die Erstellung von Wireframes sowie die Ausarbeitung der Informationsarchitektur. Darauf aufbauend wurde ein Prototyp erstellt, der bereits Animationen und ein ausgearbeitetes UI-Design beinhaltete. Aus diesem Grund konnte auf die zusätzliche Erstellung eines separaten Mockups verzichtet werden. Die eigentliche Implementierung orientiert sich an vielen Stellen stark an dem zuvor erstellten Prototypen, da dieser bereits eine sehr genaue Vorstellung der finalen Benutzeroberfläche vermittelte.
\subsubsection{Wireframes und Prototypen}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{content/img/4_Technische_Umsetzung/Mockups_2.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{content/img/4_Technische_Umsetzung/Mockups_1.jpg}
    \caption{Mockups der Hauptansichten der Anwendung WoSamma}
    \label{fig:beispielabbildung}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{content/img/4_Technische_Umsetzung/Mockups_3.jpg}
    \caption{Mockups der Spielansichten der Anwendung WoSamma}
    \label{fig:beispielabbildung}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{content/img/4_Technische_Umsetzung/Mockups_4.jpg}
    \caption{Mockups der Registrierungsansichten der Anwendung WoSamma}
    \label{fig:beispielabbildung}
\end{figure}
...
\subsubsection{Navigation und Informationsarchitektur}
...
\subsubsection{Komponentenstruktur und Wiederverwendbarkeit}
% UI-Bausteine, Konsistenz, Skalierbarkeit

\subsubsection{Datenhandling im Frontend}
% State, Loading, Error-Handling, API-Konsum

\subsubsection{Responsives Design und Barrierefreiheit}
% Responsive Layouts, Touch Targets, Accessibility

\subsubsection{Spielansicht und Benutzerinteraktion}
\paragraph{Pin-Platzierung im Einzelspieler-Modus}
\paragraph{Pin-Platzierung im Mehrspieler-Modus}
\paragraph{Visualisierung der geschätzten und realen Position}
\paragraph{Integration der Google APIs im Frontend}
\paragraph{Darstellung von Begrenzungslinien der Bundesländer}
\paragraph{Live-Chat und Echtzeit-Updates}
