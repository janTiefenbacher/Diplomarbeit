...
\textbf{iOS}\\
iOS ist das mobile Betriebssystem von Apple, welches auf Geräten wie den Iphones oder Ipads verwendet wird. 
Es ist für Touch-Bedienung konzipiert und bekannt für hohe Sicherheitsstandards und eine intuitive 
Benutzeroberfläche. Technisch basiert iOS auf einem Unix-ähnlichen System-Kernel 
namens Darwin, was eine solide, stabile Basis für moderne mobile Anwendungen schafft. Apple verbindet Hard und Software sehr eng miteinander und kontrolliert
die Plattformen stark, daher können Updates, Sicherheitsmechanismen und Apple-Dienste über alle Geräte sehr einheitlich 
bereitgestellt werden. Um eine entwickelte Applikation für iOS Geräte verfügbar zu machen, muss diese auf dem Apple App Store veröffentlicht werden,
wobei durch strenge Richtlinien und Prüfprozesse sichergestellt wird, dass nur qualitativ hochwertige und sichere Apps zugelassen werden. Außerdem braucht man 
...
alle System- und Benutzerkomponenten umfasst, also das Linux-Kernel-Betriebssystem, die grafische Oberfläche und die verfügbaren Apps. Android 
wurde unter der Apache-Open-Source-Lizenz veröffentlicht, dies erlaubt Hertsellern und Entwicklern, die Software zu individuellen Varianten zu modifizieren. Obwohl die Basis offen ist, enthalten die meisten Geräte zusätzliche Basis-Programme wie Google-Apps, die vorinstalliert sind. 
Android zählt daher zu den am meisten verbreiteten Betriebssystemen weltweit. Um eine Applikation für Android-Geräte verfügbar zu machen, 
wird diese in der Regel über den Google Play Store vertrieben. Auch hier gibt es Richtlinien und Prüfverfahren, welche sicherstellen, dass nur 
...
iOS- und Android-Systeme unterscheiden sich in vielen Bereichen, darunter in ihrer Systemarchitektur, 
Designrichtlinien und Gerätevielfalt. Während iOS auf eine begrenzte Anzahl an Geräten 
optimiert ist, existiert im Android-Bereich eine große Vielfalt an Bildschirmgrößen und 
Hardwarekonfigurationen. Diese Unterschiede erhöhen den Entwicklung- und Wartungsaufwand 
bei nativen Anwendungen, also Anwendung, welche speziell für ein bestimmtes Betriebssystem entwickelt wurden.
...
für iOS und Android zu ermöglichen. (Technische Details folgen in Abschnitt: 3.0.4.1.1. React Native Framework)

% --------------------------------------------------
\section{UI/UX-Design \& Nutzererlebnis}
...
\subsection{Trends, Designkonzepte \& Weiterentwicklungen im App-Design}
...
\subsection{Informationsarchitektur \& Navigation}
...
\subsection{Wireframes, Mockups \& Prototypen}

Diese Design-Artefakte sind zentrale Bestandteile des modernen Designprozesses für digitale Produkte wie Websites, 
...
als die von Wireframes, langfristig helfen sie jedoch, Fehlentwicklungen und teure Nachbesserungen zu vermeiden.\cite{popwebdesign_wire}\cite{justinmind_wireframe_prototyp_mockup}\cite{miro_wire}\cite{justinmindLowHigh_fidelity} \\
...
dienen Mockups vor allem der Beurteilung des visuellen Designs. Oft wird aber auch auf Mockups verzichtet wenn der Prototyp bereits stark visuell ausgearbeitet ist (High-Fidelity-Prototypen).\cite{popwebdesign_wire}\cite{justinmind_wireframe_prototyp_mockup}\cite{miro_wire}\cite{justinmindLowHigh_fidelity}\\

\textbf{Zusammenspiel im Designprozess} \\
Die verschiedenen Design-Artefakte sind keine konkurrierenden Phasen, sondern ergänzen sich und bauen aufeinander auf. In der Regel beginnt der
Designprozess mit Wireframes, die als Fundament des Designs dienen. Danach werden Mockups angefertigt um das visuelle Erscheinungsbild zu evaluieren und perfektionieren. Sobald Struktur und Funktionalität festgelegt sind, 
werden diese Entwürfe in Prototypen überführt, um das Nutzungserlebnis realistisch darzustellen und zu testen.\cite{popwebdesign_wire}\cite{justinmind_wireframe_prototyp_mockup}\cite{miro_wire}
\vspace{0.5em}

\subsection{Visuelles Design}

Das Visuelle Design bezeichnet die Gestaltung der Inhalte mit dem Ziel, Applikationen und digitae Inhalte
visuell ansprechend und zugleich funktional zu gestalten. Es bildet eine zentrale Schnittstelle zwischen
Gestaltung und Nutzererfahrung, da es nicht nur das äußere Erscheinungsbild eines Produkts prägt, sondern 
auch im Wesentlichen beeinflusst, wie Inhalte wahrgenommen, verstanden und genutzt werden. In der digitalen Welt 
ist visuelles Design daher ein wichtiger Bestandteil von Webanwendungen, Software, Marketingplattformen 
...
In diesem Kapitel werden der globale App-Markt und die verschiedenen Strategien zur Monetarisierung mobiler Apps vorgestellt.
...
\end{itemize}
Solche personalisierten Inhalte fördern die Bindung der Nutzer an die App und stellen insbesondere bei engagierten Nutzern eine effektive Einnahmequelle dar.\cite{Kostenpflichtige_Ideen}
...
\item \textbf{Realtime-Funktionalität:} Dienste zur Verwaltung von Echtzeit-Datenübertragungen und -Präsenz mittels skalierbarer WebSocket-Technologien.
...
Insgesamt bieten BaaS-Plattformen wie Supabase eine abstrahierte Backend-Schicht, die viele klassische Backend-Aufgaben übernimmt und Entwickler von der Notwendigkeit befreit, eigene Backend-Infrastruktur manuell aufzusetzen oder zu warten \cite{supabase_overview_chauhan}.
...
% --------------------------------------------------
\section{Hosting- und Infrastrukturmodelle}
...
\subsection{On-Premise, Cloud und Hybrid-Architekturen}
...
\subsection{IaaS, PaaS, FaaS und Serverless}
...
\subsection{Autoscaling und Lastverteilung}
...
\subsection{Latenzoptimierung und Durchsatzsteigerung}
